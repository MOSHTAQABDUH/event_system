            ...
            <div class="container">
              <div class="container-fluid">
                ...
                <div class="navbar-header">
                  ...
                  <img class="mb-2" src="<?php echo base_url().'public/images/logo.SVG " alt=""   height="50" '  ?>">
                  ...
                  <ul class="nav navbar-nav">
                    ...
                    <?php
                        if($dataLevel == 'is_admin'){ //Check user level if is Admin
                            echo'
                            <li class="dropdown">
                              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-users" aria-hidden="true"></i> الاعضاء <span class="caret"></span></a>
                              <ul class="dropdown-menu">
                                <li><a href="'.site_url().'main/users">عرض الاعضاء</a></li>
                                <li><a href="'.site_url().'main/adduser">إضافة عضو</a></li>  
                              </ul>
                            </li>
                ...
                <img class="mb-2" src="<?php echo base_url().'public/images/kpi_log.png " alt=""   height="50" '  ?>">
                </div><!-- /.navbar-collapse -->
              </div><!-- /.container-fluid -->
            </div>
        </nav>
       <!-- <center><img class="mb-2" src="<
         ?php echo base_url().'public/images/logo.png" alt="" width="72" height="72" '  ?>"></center>  -->
