...
gj.tree.config = {
    base: {
        ...
        icons: {
            /** Expand icon definition.             */            expand: '<i class="fas fa-chevron-right"></i>',

            /** Collapse icon definition.             */            collapse: '<i class="fas fa-chevron-down"></i>'
        }
    },
    ...
    bootstrap4: {
        ...
        icons: {
            expand: '<i class="fas fa-chevron-right"></i>',
            collapse: '<i class="fas fa-chevron-down"></i>'
        }
    },
